...
import com.linkedin.nn.Types.{BandedHashes, Item, ItemId, ItemIdDistancePair}
import com.linkedin.nn.distance.Distance
import com.linkedin.nn.lsh.HashFunction
import com.linkedin.nn.params.{HasSeed, LSHNNSParams}
...
abstract class LSHNearestNeighborSearchModel[T <: LSHNearestNeighborSearchModel[T]]
  ...
  private[nn] def getHashFunctions: Array[_ <: HashFunction]
